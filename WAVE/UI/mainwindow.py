...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.reportedValueName = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.reportedValueName.setFont(font)
        self.reportedValueName.setObjectName("reportedValueName")
        self.gridLayout_2.addWidget(self.reportedValueName, 14, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actualValueLabel.setText(_translate("MainWindow", "Actual Value"))
        self.reportedValueName.setText(_translate("MainWindow", "Johnson"))
